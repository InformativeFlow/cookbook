<powershell>
 ...
 $env:CHEF_SERVER_NAME = "ariadna" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "ariadna-rj7kzksjpmn299k3.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
