...
CHEF_SERVER_NAME="ariadna" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="ariadna-rj7kzksjpmn299k3.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
